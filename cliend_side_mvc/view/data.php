...
<nav class="bg-[#FEB600] p-4 text-white">
    ...
    <section class = " bg-gray-50 p-5 mt-8 mid-h-screen flex itmes-center justify-center" >
        ...
        <div class= "bg_cyan-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
             ...
             <!--form-->
             <form action="../controller/dataController.php" method="POST" class="sm:w-2/3 px-16">
             <div class="sm:w-50 px-16" >
    ...
    <div class=" px-16 ">
                ...
                <input class="border-2 transition duration-500 placeholder-gra-400 focus:placeholder-transparent
                 ...
                 <button type="submit" name="submit"  class="bg-[#FEB600] w-2/4 -center mt-2 text-white py-2 border rounded-xl hover:scale-105">Next</button>
            ...
            <div class="mt-4">
              ...
              <!--image-->
              <div class="w-2/5 md:block hidden">
